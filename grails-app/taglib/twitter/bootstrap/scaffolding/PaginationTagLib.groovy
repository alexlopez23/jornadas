...
class PaginationTagLib {
	...
	def paginate = { attrs ->
		...
		if (currentstep > firststep) {
			...
			writer << link(prevLinkAttrs, '<span aria-hidden="true">&laquo;</span><span class="sr-only">'+prevLinkAttrs.title+'</span>')
			writer << '</li>'
		}
		...
		if (currentstep < laststep) {
			...
			writer << link(nextLinkAttrs, '<span aria-hidden="true">&raquo;</span><span class="sr-only">'+nextLinkAttrs.title+'</span>')
			writer << '</li>'
		}
